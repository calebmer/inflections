...
mod tests {
  ...
  #[bench]
  fn bench_std_lower_case(b: &mut Bencher) {
    b.iter(|| assert_eq!("Hello world".to_lowercase(), "hello world"));
  }

  #[bench]
  fn bench_lower_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_lower_case("Hello world"), "hello world".to_owned()));
  }

  #[bench]
  fn bench_std_upper_case(b: &mut Bencher) {
    b.iter(|| assert_eq!("Hello world".to_uppercase(), "HELLO WORLD"));
  }

  #[bench]
  fn bench_upper_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_upper_case("Hello world"), "HELLO WORLD".to_owned()));
  }

  #[bench]
  fn bench_sentence_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_sentence_case("Hello world"), "hello world".to_owned()));
  }

  #[bench]
  fn bench_title_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_title_case("Hello world"), "Hello World".to_owned()));
  }

  #[bench]
  fn bench_camel_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_camel_case("Hello world"), "helloWorld".to_owned()));
  }

  #[bench]
  fn bench_pascal_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_pascal_case("Hello world"), "HelloWorld".to_owned()));
  }

  #[bench]
  fn bench_kebab_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_kebab_case("Hello world"), "hello-world".to_owned()));
  }

  #[bench]
  fn bench_train_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_train_case("Hello world"), "Hello-World".to_owned()));
  }

  #[bench]
  fn bench_snake_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_snake_case("Hello world"), "hello_world".to_owned()));
  }

  #[bench]
  fn bench_constant_case(b: &mut Bencher) {
    b.iter(|| assert_eq!(to_constant_case("Hello world"), "HELLO_WORLD".to_owned()));
  }
}
